...
def fetch_poster(movie_id):
    url = f"https://api.themoviedb.org/3/movie/{movie_id}?api_key=4663369eda0a9a8626ad0f8a3b4f41df"
...
movies = joblib.load(r'C:\ML\movie recommendation\models\movie_list.sav')
similarity = joblib.load(r'C:\ML\movie recommendation\models\similarity.sav')
